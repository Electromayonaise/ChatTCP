...
/*OBJETIVO: RECIBIR DOS AUDIOS Y COMBINARLOS EN UNO */
...
public class AudioRecorderPlayer {
    ...
    public static void main(String[] args) {
        ...
        //iniciar objeto de grabacion de audio
        RecordAudio recorder2 = new RecordAudio(format, duration,byteArrayOutputStream2);
        Thread recorder2Thread  = new Thread(recorder2);
        recorder2Thread.start();
        //esperar a que la grabacion termine
        try{
            recorder2Thread.join();
        }catch(Exception e){
            //TODO
        }
        ...
        player.initiateAudio(audioData,audioData2);
